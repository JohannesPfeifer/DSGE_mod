...
var a ${a}$ (long_name='preference shock')
    ...
    pihat ${\hat p}$ (long_name='preference shock')
    ...
    gobs ${g^{obs}}$ (long_name='interest deviations from trend')
    robs ${r^{obs}}$ (long_name='interest deviations from trend')
    piobs ${\pi^{obs}}$ (long_name='interest deviations from trend')
    r_annual ${r^{ann}}$ (long_name='interest deviations from trend')
    pi_annual ${\pi^{ann}}$ (long_name='interest deviations from trend')
        ; 
