...
stoch_simul(order=3,k_order_solver,nograph,noprint,nomoments,nofunctions,nocorr,irf=0) log_Y log_K log_C log_I log_mu log_N sigma_z sigma_G log_pi_annualized log_R_annualized log_W firm_wedge household_wedge G Z;
