 ...
 * Princeton University Press, Chapter 5.1.1
 *
...
discretionary_policy(instruments=(i),irf=20,planner_discount=betta,discretionary_tol=1e-12) x pi p u;

set_param_value('rho_u',0.8);

discretionary_policy(instruments=(i),irf=20,discretionary_tol=1e-12) x pi p u;
